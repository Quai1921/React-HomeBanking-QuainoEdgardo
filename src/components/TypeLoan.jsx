...
function TypeLoan({typeLoan, maxAmount, payments}) {
    return (
            <div className='flex flex-col items-center flex-wrap justify-center bg-gray-200 rounded-2xl py-6 shadow-black shadow-lg px-3 '>
                <img className='w-64' src={`/${typeLoan}.png`} alt="Image type loan" />
                <div className='p-3 flex gap-2 items-center'>
                    <div className='w-[265px]'>
                        <div className='flex justify-center items-center gap-3 bg-white  rounded-xl p-3 shadow-black shadow-sm'>
                        ...
                        <div className='flex flex-col pt-3'>
                            ...
                            <p className='font-bold text-2xl  text-red-600 text-center pb-2'>{maxAmount.toLocaleString('en-US', {style:'currency', currency:'USD'})}</p>
...
// hover:scale-105 transition-all duration-[350ms] ease-in
