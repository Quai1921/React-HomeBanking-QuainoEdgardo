...
function CarrouselHome() {
    ...
    <div className='pt-10'>
        ...
        >
            <SwiperSlide style={{ maxWidth: '400px'}}><div className='rounded-2xl h-full relative' >
                            ...
                            <div className='bg-[url("/Bg-Card-01.png")] bg-cover rounded-b-xl h-[370px]'>
                                <p className='text-center font-semibold pt-2 md:pt-8 px-3 italic bg-gray-300 bg-opacity-80 h-[370px] rounded-b-xl'>Explore a range of personalized loan solutions designed to meet your unique financial needs. 
            ...
            <SwiperSlide style={{ maxWidth: '400px'}}><div className='rounded-2xl h-full relative'>
                            ...
                            <div className='bg-[url("/Bg-Card-02.png")] bg-cover rounded-b-xl h-[370px]'>
                                <p className='text-center font-semibold pt-2 md:pt-8 px-3 italic bg-gray-300 bg-opacity-80 h-[370px] rounded-b-xl'>Experience the simplicity of opening a bank account with us. Our streamlined process ensures that you 
            ...
            <SwiperSlide style={{ maxWidth: '400px'}}><div className='rounded-2xl h-full relative'>
                            ...
                            <div className=' bg-[url("/Bg-Card-03.png")] bg-cover rounded-b-xl h-[370px]'>
                                <p className='text-center font-semibold pt-2 md:pt-8 px-3 italic bg-gray-300 bg-opacity-80 h-[370px] rounded-b-xl'>At Mind Hub Bank, we redefine simplicity in financial services. Acquiring credit and debit cards has 
            ...
            <SwiperSlide style={{ maxWidth: '400px'}}><div className='rounded-2xl h-full relative'>
                            ...
                            <div className=' bg-[url("/Bg-Card-04.png")] bg-cover rounded-b-xl h-[370px]'>
                                <p className='text-center font-semibold pt-2 md:pt-8 px-3 italic bg-gray-300 bg-opacity-80 h-[370px] rounded-b-xl'>Experience the freedom of banking on your terms. Our online services provide a secure and 
            ...
            <SwiperSlide style={{ maxWidth: '400px'}}><div className='rounded-2xl h-full relative'>
                            ...
                            <div className=' bg-[url("/Bg-Card-05.png")] bg-cover rounded-b-xl h-[370px]'>
                                <p className='text-center font-semibold pt-2 md:pt-8 px-3 italic bg-gray-300 bg-opacity-80 h-[370px] rounded-b-xl'>At Mind Hub Bank, we redefine convenience by offering effortless payment solutions and streamlined 
